...
class TestBashAnalysis:
    ...
    def test_brace_unbraced_vars_output_host(self):
        ...
        assert any(
            f.description == "Dodano klamerki do zmiennych" for f in result.fixes
        )
...
class TestPythonAnalysis:
    ...
    def test_none_comparison_autofix(self):
        ...
        assert any(
            f.description.startswith("Zmieniono porównanie do None")
